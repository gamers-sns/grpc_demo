...
function fastifyConnectPlugin(instance, opts, done) {
    ...
    for (const uHandler of uHandlers) {
        instance.all(uHandler.requestPath, {}, async function handleFastifyRequest(req, reply) {
            var _a;
            try {
                const uRes = await uHandler((0, connect_node_1.universalRequestFromNodeRequest)(req.raw, req.body, (_a = opts.contextValues) === null || _a === void 0 ? void 0 : _a.call(opts, req)));
