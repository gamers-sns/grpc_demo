...
var connect_fastify_1 = require("@connectrpc/connect-fastify");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    _a.sent();
                    // Connectのルートを登録
                    return [4 /*yield*/, server.register(connect_fastify_1.fastifyConnectPlugin, {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, server.listen({ host: "localhost", port: 50051 })];
                case 3:
                    _a.sent();
